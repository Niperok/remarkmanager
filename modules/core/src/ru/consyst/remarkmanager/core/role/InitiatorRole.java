...
public class InitiatorRole extends AnnotatedRoleDefinition {
    public final static String NAME = "InitiatorRole";
    ...
    @EntityAccess(entityClass = Remark.class, operations = {EntityOp.CREATE, EntityOp.READ, EntityOp.UPDATE})
    @Override
    public EntityPermissionsContainer entityPermissions() {
        return super.entityPermissions();
    }

    @EntityAttributeAccess(entityClass = Remark.class, modify = {"product", "remarkType", "description", "initiator", "remarkDate"}, view = "*")
    @Override
